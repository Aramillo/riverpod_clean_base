...
class _$MovieDetailModelImpl extends _MovieDetailModel {
  ...
  @override
  String toString() {
    return 'MovieDetailModel(id: $id, title: $title, overview: $overview, posterPath: $posterPath, backdropPath: $backdropPath, voteAverage: $voteAverage, voteCount: $voteCount, releaseDate: $releaseDate, runtime: $runtime, genres: $genres, tagline: $tagline)';
  }
